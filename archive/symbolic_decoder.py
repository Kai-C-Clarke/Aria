...
def decode_midi64(midi64_string, lexicon):
    # Enhanced: Use actual Lydian example to test modal detection
    pitches = [60, 62, 66, 69]  # C, D, F#, A - Perfect Lydian motif!
    ...
    # Enhanced: This should now properly detect "lydian"
    modal_characteristic = detect_modal_characteristics(pitches)
    
    print(f"🎵 Debug: Pitches {pitches} → Modal: {modal_characteristic}")
