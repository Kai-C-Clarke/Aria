...
class MuseGUILauncher:
    def __init__(self):
        ...
        # Setup logging to capture subprocess output
...
if __name__ == "__main__":
    main()setup_logging()
        ...
        # Check for MUSE components on startup
    ...
    def create_output_panel(self, parent):
        """Create the output panel with logs and status"""
    ...
    def display_message(self, message):
        ...
        # Also update MUSE tab if it's a MUSE-related message
    ...
    def check_muse_components(self):
        """Check if MUSE Protocol components are available"""
        def check():
            try:
    ...
    def toggle_muse_exchange(self):
        """Start or stop the MUSE Protocol exchange"""
    ...
    def start_muse_exchange(self):
        """Start the MUSE Protocol exchange"""
        if self.is_running:
            return
        ...
        def run_exchange():
            try:
                ...
                # Run the main MUSE exchange script
    ...
    def stop_muse_exchange(self):
        """Stop the MUSE Protocol exchange"""
        if not self.is_running:
            return
